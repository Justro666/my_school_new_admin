    ...
    <center style="width: 100%; background: #f1f1f1; text-align: left">
        <div style="max-width: 680px; margin: auto" class="email-container">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%"
                ...
                <tr>
                    <!-- top color -->
                    <td bgcolor="#000000" align="center" valign=""
                        style="
                text-align: center;
              ...
              ">
                ...
                <tr>
                    ...
                    ">
                                    <p style="margin: 0">
                                        <b> We would like to inform your email address and password to access the Ex;braiN Website below.</b>
                                        <br />
                                        Email : {{ $email }} <br />
                    ...
                    <td bgcolor="#ffffff">
                      ...
                      padding-left: 30px;">
                                    <img src="https://myschoolstorage.sgp1.digitaloceanspaces.com/emailLogo/zpfooter/ringingphoneoutlineicon.png"
                                        ...
                                        srcset=""><span style="opacity: 0.6;">{{ $phone }}</span>
                                </td>
